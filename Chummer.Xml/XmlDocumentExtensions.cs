    ...
    public static class XmlDocumentExtensions
    {
        ...
        public static void LoadStandard(this XmlDocument xmlDocument, string strFileName, bool blnSafe = true)
        {
            ...
            using (XmlReader objReader = XmlReader.Create(objStreamReader,
                blnSafe ? XmlUtilities.SafeXmlReaderSettings : XmlUtilities.UnSafeXmlReaderSettings))
        ...
        {
            using (FileStream objFileStream = new FileStream(strFileName, FileMode.Open, FileAccess.Read, FileShare.Read))
            using (RecyclableMemoryStream objMemoryStream = XmlUtilities.GetRecyclableStream("LzmaMemoryStream", objFileStream.Length))
            {
        ...
        public static XPathNavigator GetFastNavigator(this XmlDocument xmlDocument)
        {
            if (xmlDocument == null)
                return null;
            using (RecyclableMemoryStream objMemoryStream = XmlUtilities.GetRecyclableStream())
            {
                ...
                using (XmlReader objXmlReader = XmlReader.Create(objMemoryStream, XmlUtilities.UnSafeXmlReaderSettings))
                ...
                : Task.Run(() =>
                {
                    using (RecyclableMemoryStream objMemoryStream = XmlUtilities.GetRecyclableStream())
                    {
                        ...
                        using (XmlReader objXmlReader
                               = XmlReader.Create(objMemoryStream, XmlUtilities.UnSafeXmlReaderSettings))
                        {
                            token.ThrowIfCancellationRequested();
